...
void PlayState::Enter(Game& game)
{
	...
	auto c2T = game.GetTextureManager().GetTexture("assets/graphics/cloud6/3.png");
	auto c3T = game.GetTextureManager().GetTexture("assets/graphics/cloud6/4.png");
	auto c4T = game.GetTextureManager().GetTexture("assets/graphics/cloud6/5.png");
